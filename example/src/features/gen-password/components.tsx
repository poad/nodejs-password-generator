...
export function GenPassword() {
  ...
  return (
    <div class="flex flex-col p-4">
        ...
        <Suspense fallback="Generating...">
          <div class="flex flex-col p-4">
                ...
                <FiCopy
                  onClick={() => {
                    ...
                    if (value) {
                      ...
                      setStore((prev) => ({ ...prev, copied: true }));
                    }
                  }}
                  title="クリップボードにコピーする"
                  class="self-center"
            ...
            <div class="p-2 border-gray-400 rounded border">
              <div class="flex pb-2">
                <label for="length" class="self-center pr-2">
                  Length
                </label>
                <input
                  type="number"
              ...
              <div class="flex pb-2">
                <label for="upperCase" class="self-center pr-2">
                  Include Uppercase
                </label>
                <input
                  type="checkbox"
              ...
              <div class="flex pb-2">
                <label for="lowerCase" class="self-center pr-2">
                  Include Lowercase
                </label>
                <input
                  type="checkbox"
              ...
              <div class="flex pb-2">
                <label for="digits" class="self-center pr-2">
                  Include Digists
                </label>
                <input
                  type="checkbox"
              ...
              <div class="flex pb-2">
                <label for="symbols" class="self-center pr-2">
      ...
      <div class="flex">
        <a
          href="https://github.com/poad/nodejs-password-generator"
          class="underline"
          target="_blank"
          rel="noopener"
        >
          <OcMarkgithub2 class="self-center inline mr-2" title="GitHub Repository" />
          Source Code
        </a>
      </div>
    </div>
